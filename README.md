...
Below you will find API for each component that exists inside this package. For more advance usage (like shadows, position changing, animations, etc.) you can find that further below under [`Advanced API`](https://github.com/JaViLuMa/isometric-react#advanced-api) section.
